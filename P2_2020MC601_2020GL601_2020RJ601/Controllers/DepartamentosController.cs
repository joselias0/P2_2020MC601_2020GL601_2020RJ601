...
namespace P2_2020MC601_2020GL601_2020RJ601.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(casos_covidContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamentos != null ? 
                          ...
                          Problem("Entity set 'casos_covidContext.Departamentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'casos_covidContext.Departamentos'  is null.");
            }
            var departamentos = await _context.Departamentos.FindAsync(id);
            if (departamentos != null)
            {
